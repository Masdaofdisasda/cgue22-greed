...
toktx --target_type RGBA --assign_oetf srgb "albedo.ktx" @path^"

echo convert ao textures
forfiles /s /m *ao.png /c ^"cmd /c ^
echo converting @path^&^
toktx --assign_oetf linear "ao.ktx" @path^"
...
echo converting @path^&^
toktx --assign_oetf linear "height.ktx" @path^"

echo convert metal textures
forfiles /s /m *metal.png /c ^"cmd /c ^
echo converting @path^&^
toktx --assign_oetf linear "metal.ktx" @path^"
...
echo converting @path ^&^
toktx --assign_oetf linear "rough.ktx" @path^"
